    ...
    <section className="py-16 sm:py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-sure-blue-500 mb-4">
            Why Choose <span className="text-sure-red-500">Sure Filter®</span>?
          </h2>
          <p className="text-lg text-sure-blue-600 max-w-2xl mx-auto">
            Experience the difference with our premium filtration solutions designed for extreme performance.
          </p>
        </div>
            ...
            return (
              <div key={index} className="group text-center p-8 bg-white rounded-xl border border-gray-100 hover:border-sure-blue-200 transition-all duration-300 hover:-translate-y-2 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-sure-red-100 to-sure-red-200 text-sure-red-600 rounded-2xl mb-6 group-hover:scale-110 transition-all duration-300">
                    <IconComponent className="w-10 h-10" />
                  </div>
                </div>
                
                <h3 className="relative z-10 text-xl font-semibold text-sure-blue-500 mb-4 group-hover:text-sure-blue-600 transition-colors duration-300">
                  {feature.title}
                </h3>
