...
export default function EditSpecParameterPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (loading) {
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        <div className="text-center text-gray-500">Loading parameter...</div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Edit Specification Parameter</h1>
        ...
        <nav className="flex text-sm text-gray-500 mt-4">
          ...
          <span className="mx-2">/</span>
          <Link href="/admin/products/spec-parameters" className="hover:text-gray-700">Spec Parameters</Link>
          <span className="mx-2">/</span>
