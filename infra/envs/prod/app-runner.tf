resource "aws_apprunner_service" "surefilter" {
  ...
  source_configuration {
    ...
    image_repository {
      image_identifier      = "${aws_ecr_repository.surefilter.repository_url}:${var.app_runner_image_version}"
      ...
      image_configuration {
        ...
        runtime_environment_variables = {
          ...
          NEXT_SERVER_ACTIONS_ALLOWED_ORIGINS = "surefilter.us,https://surefilter.us,www.surefilter.us,https://www.surefilter.us,new.surefilter.us,https://new.surefilter.us,qiypwsyuxm.us-east-1.awsapprunner.com,https://qiypwsyuxm.us-east-1.awsapprunner.com"
